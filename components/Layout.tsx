        ...
        <header ref={navbarRef} className={headerClass}>
            ...
            <div className="relative flex items-center gap-4">
               ...
               {isProfileMenuOpen && (
                  <div 
                    ref={profileMenuRef}
                    className="absolute right-0 top-12 mt-3 w-60 bg-white/95 backdrop-blur-xl rounded-2xl shadow-xl border border-slate-100 py-2 z-[100] animate-fade-in dark:bg-slate-900/95 dark:border-slate-700"
                  >
             ...
             <div className="relative">
                ...
                {isMobileProfileMenuOpen && (
                    <div
                        ...
                        className="absolute right-0 top-12 mt-2 w-56 bg-white/95 backdrop-blur-xl rounded-2xl shadow-xl border border-slate-100 py-2 z-[100] animate-fade-in dark:bg-slate-900/95 dark:border-slate-700"
                    >
                        <div className="px-4 py-3 border-b border-slate-100 dark:border-slate-700">
                            <p className="text-sm font-bold text-slate-800 dark:text-white">Signed in as</p>
                            <p className="text-xs text-slate-500 truncate dark:text-slate-400 mt-0.5">{currentUser.email}</p>
