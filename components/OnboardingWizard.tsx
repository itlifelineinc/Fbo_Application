        ...
        <div className="p-8 md:p-12">
          ...
          {step === 0 && (
            <div className="text-center space-y-6 animate-fade-in">
              ...
              <h1 className="text-4xl font-bold text-emerald-950">Start Your Forever Journey</h1>
          ...
          {step === 1 && (
            <div className="space-y-8 animate-fade-in">
              <div className="text-center">
                <h2 className="text-2xl font-bold text-emerald-950">Your Goals</h2>
          ...
          {step === 2 && (
            <div className="space-y-8 animate-fade-in text-center">
              <div>
                <h2 className="text-2xl font-bold text-emerald-950">Sponsor Verification</h2>
          ...
          {step === 3 && (
            <div className="space-y-8 animate-fade-in">
               <div className="text-center">
                <h2 className="text-2xl font-bold text-emerald-950">Create Profile</h2>
          ...
          {step === 4 && (
             <div className="text-center space-y-6 animate-fade-in py-8">
                ...
                <h1 className="text-3xl font-bold text-emerald-950">Welcome, {name.split(' ')[0]}!</h1>
...
const CheckBadgeIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
        <path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75L11.25 15 15 9.75M21 12c0 1.268-.63 2.39-1.593 3.068a3.745 3.745 0 01-1.043 3.296 3.745 3.745 0 01-3.296 1.043A3.745 3.745 0 0112 21c-1.268 0-2.39-.63-3.068-1.593a3.746 3.746 0 01-3.296-1.043 3.745 3.745 0 01-1.043-3.296A3.745 3.745 0 0112 3c1.268 0 2.39.63 3.068 1.593a3.746 3.746 0 013.296 1.043 3.746 3.746 0 011.043 3.296A3.745 3.745 0 0121 12z" />
    </svg>
);
