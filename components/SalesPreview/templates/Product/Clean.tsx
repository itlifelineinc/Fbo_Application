...
const ProductClean: React.FC<ProductCleanProps> = ({ 
  ...
  const isDarkBg = ['#064e3b', '#111827', '#000000', '#1e1b4b', '#4c0519'].includes(data.pageBgColor);
    ...
    <div className="flex flex-col relative min-h-full">
      ...
      {data.ctaDisplay?.showFloatingWhatsapp && !heroButtonVisible && (
          <a 
            ...
            className="absolute bottom-24 right-6 z-[60] w-14 h-14 bg-[#25D366] rounded-full shadow-2xl flex items-center justify-center text-white transition-all duration-500 animate-in fade-in zoom-in active:scale-90"
          >
      ...
      {data.description && (
          <div className="px-6 py-6 bg-white dark:bg-slate-950">
              <div className="attachment-card text-left">
                  ...
                  <div className="h-0.5 w-8 mt-2" style={{ backgroundColor: data.themeColor }}></div>
                  <p className="text-sm text-slate-700 dark:text-slate-200 leading-relaxed line-clamp-[10] mt-4">{data.description}</p>
      ...
      {product?.benefits?.length > 0 && (
          <div className="px-6 py-4 bg-white dark:bg-slate-950">
              <div className="attachment-card text-left">
                  ...
                  <div className="h-0.5 w-8 mt-2 mb-4" style={{ backgroundColor: data.themeColor }}></div>
      ...
      {product?.usageSteps?.length > 0 && (
          <div className="px-6 py-4 bg-white dark:bg-slate-950">
              <div className="attachment-card text-left">
                  ...
                  <div className="h-0.5 w-8 mt-2 mb-8" style={{ backgroundColor: data.themeColor }}></div>
