...
const WhatsAppFloatingButton: React.FC<WhatsAppFloatingButtonProps> = ({ 
  ...
  return (
    <a 
      ...
      className={`z-50 flex items-center justify-center w-14 h-14 bg-[#25D366] rounded-full shadow-lg hover:scale-110 transition-transform cursor-pointer ${className || 'fixed bottom-6 right-6'}`}
