        ...
        <div className="p-8 md:p-12">
          ...
          {step === 0 && (
            <div className="text-center space-y-6 animate-fade-in flex flex-col items-center">
              <Logo className="w-20 h-20" textClassName="text-3xl font-bold text-emerald-950 font-heading mt-2" />
              <h1 className="text-4xl font-bold text-emerald-950 font-heading">Start Your Journey</h1>
